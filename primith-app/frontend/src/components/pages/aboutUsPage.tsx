...
export function AboutUsPage() {
  ...
  return (
    <div className="min-h-screen dark:bg-black text-white">
      ...
      {/* OUR STORY SECTION */}
      <section className="py-16 md:py-20 bg-gradient-to-b from-gray-200/10 to-gray-500/10">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold tracking-tight mb-6 text-gray-800 dark:text-gray-100">
              Our Story
            </h2>
